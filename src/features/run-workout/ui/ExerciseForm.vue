...
<template>
  <div class="text-white flex items-center justify-center py-6">
    <div class="w-full max-w-md bg-gray-900 rounded-2xl shadow-xl p-4 space-y-6">
      ...
      <!-- Phase Card -->
      <template v-if="currentPhase && currentPhaseIndex < workoutSession.phases.length"
        ><div
      ...
      <EndTrainingForm v-else :workout-session="workoutSession" />
